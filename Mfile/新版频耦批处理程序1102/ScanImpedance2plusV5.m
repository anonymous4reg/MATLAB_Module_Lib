...
% % % ylim([-1,7]);
% % % grid on;
% % % legend('ÆµñîÕýÐò×è¿¹Zp','ÊÓÔÚÕýÐò×è¿¹Zp','Æµñî×è¿¹Zp11','Æµñî×è¿¹Zp12','Æµñî×è¿¹Zp21','Æµñî×è¿¹Zp22','Ô­µ¥Æµ×è¿¹Zp');
% % % xlabel('ÆµÂÊ(Hz)');
% % % ylabel('·ùÖµ(om)');
% % % subplot(2,1,2);
...
% % % xlabel('ÆµÂÊ(Hz)');
% % % ylabel('Ïà½Ç(¶È)');
% % % saveas(gca, 'Æµñî·ÇÆµñî¶Ô±ÈÇúÏß_7Ìõ.fig')
% % % saveas(gca, 'Æµñî·ÇÆµñî¶Ô±ÈÇúÏß_7Ìõ.emf')
% % % saveas(gca, 'Æµñî·ÇÆµñî¶Ô±ÈÇúÏß_7Ìõ.png')
% % % 
figure
subplot(2,1,1);
...
% xlabel('ÆµÂÊ(Hz)');
% ylabel('Ïà½Ç(¶È)');
% saveas(gca, 'Æµñî¶þÎ¬×è¿¹4ÌõÇúÏß.fig')
% saveas(gca, 'Æµñî¶þÎ¬×è¿¹4ÌõÇúÏß.emf')
% saveas(gca, 'Æµñî¶þÎ¬×è¿¹4ÌõÇúÏß.png')
...
% % % % ylim([-0.1,0.4]);
% % % grid on;
% % % legend('ÆµñîÕýÐò×è¿¹Zp','Æµñî×è¿¹Zp11','Æµñî×è¿¹Zp12','Æµñî×è¿¹Zp21','Æµñî×è¿¹Zp22');
% % % xlabel('ÆµÂÊ(Hz)');
% % % ylabel('µç¿¹(om)');
% % % subplot(2,1,2);
