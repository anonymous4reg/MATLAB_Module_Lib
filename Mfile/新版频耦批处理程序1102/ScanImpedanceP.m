function  [Ip1,Vp1,Ip_coupled1,Vp_coupled1] = ScanImpedance1(Freq_begin,Freq_end,Freq_step,NN,Data)
...
for ff =f_start:f_step:f_end   
    ...
    ff_coupled=2*50-ff;
    ff_num=(ff-f_start)/f_step; %从1Hz开始对应为0
