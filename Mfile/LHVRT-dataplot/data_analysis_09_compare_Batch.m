...
for each_folder=1:length(SubFolderCell)
    ...
    sub_folder_dir_old = strcat(RootDirOld, "\", SubFolderCell{each_folder}, "\");
    ...
    told = load(strcat(sub_folder_dir_old, 'data_t'));
    tnew = load(strcat(sub_folder_dir_new, 'data_t'));
	Uold = load(strcat(sub_folder_dir_old, 'data_u'));
    Unew = load(strcat(sub_folder_dir_new, 'data_u'));

    Pold = load(strcat(sub_folder_dir_old, 'data_P'));
    Pnew = load(strcat(sub_folder_dir_new, 'data_P'));

    Qold = load(strcat(sub_folder_dir_old, 'data_Q'));
    Qnew = load(strcat(sub_folder_dir_new, 'data_Q'));

    Ipold = load(strcat(sub_folder_dir_old, 'data_Ip'));
    Ipnew = load(strcat(sub_folder_dir_new, 'data_Ip'));

    Iqold = load(strcat(sub_folder_dir_old, 'data_Iq'));
