...
MODEL           = sfun_test3_1_sm_code
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c sfun_test3_1_sm_code_data.c 
MAKEFILE        = sfun_test3_1_sm_code.mk
MATLAB_ROOT     = C:\Program Files (x86)\MATLAB\R2011b
ALT_MATLAB_ROOT = C:\PROGRA~2\MATLAB\R2011b
S_FUNCTIONS     = RECV_Param.c filter_test.c OP_SEND.c
SOLVER          = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELREFS                 = 
MODELLIB                  = sfun_test3_1_sm_codelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = sfun_test3_1_sm_code_ref.rsp
MODELREF_INC_PATH        =  
